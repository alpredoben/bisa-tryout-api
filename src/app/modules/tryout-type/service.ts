...
import { TryoutTypeModal } from '../../../database/models/TryoutTypeModal';
...
const MSG_LABEL: string = 'tryout-type';

export class TryoutTypeService {
  private repository = AppDataSource.getRepository(TryoutTypeModal);
    ...
    try {
      ...
      if (!result) {
        return {
          success: false,
          code: 404,
          message: MessageDialog.__('error.default.notFoundItem', { item: 'jenis tes' }),
          data: result,
        };
      }
